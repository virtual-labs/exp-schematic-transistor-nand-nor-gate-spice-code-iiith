...
export function printObsTableNAND() {
    ...
    if (p1_drain === out && (p1_gate === in1 || p1_gate === in2) && p1_source === "vdd" && p1_body === "vdd") {
        p1 = true;
    }
    ...
    if (p2_drain === out && (p2_gate === in1 || p2_gate === in2) && p1_gate !== p2_gate && p2_source === "vdd" && p2_body === "vdd") {
        p2 = true;
    }
    ...
    if (n1_drain === out && (n1_gate === in1 || n1_gate === in2) && n1_gate === p2_gate && (n1_body === "0" || n1_body === "gnd")) {
        if (n1_source !== "vdd" && n1_source !== "0" && n1_source !== "gnd" && n1_source !== "Wp" && n1_source !== "Wmin" && n1_source !== "Lmin" && n1_source !== convertToLowerCase(pmos1Name.value.trim()) && n1_source !== convertToLowerCase(pmos2Name.value.trim()) && n1_source !== convertToLowerCase(nmos1Name.value.trim()) && n1_source !== convertToLowerCase(nmos2Name.value.trim()) && n1_source != in1 && n1_source !== in2 && n1_source !== out) {
    ...
    if (n2_drain === n1_source && (n2_gate === in1 || n2_gate === in2) && n2_gate === p1_gate && (n2_source === "0" || n2_source === "gnd") && (n2_body === "gnd" || n2_body === "0")) {
        n2 = true;
    }
...
export function printObsTableNOR() {
    ...
    const p1_source = convertToLowerCase(pmos1Source.value.trim())
    const p1_body = convertToLowerCase(pmos1Body.value.trim())
    if (p1_drain === out && (p1_gate === in1 || p1_gate === in2) && p1_body === "vdd") {
        if (p1_source !== "vdd" && p1_source !== "0" && p1_source !== "gnd" && p1_source !== "Wp" && p1_source !== "Wmin" && p1_source !== "Lmin" && p1_source !== convertToLowerCase(pmos1Name.value.trim()) && p1_source !== convertToLowerCase(pmos2Name.value.trim()) && p1_source !== convertToLowerCase(nmos1Name.value.trim()) && p1_source !== convertToLowerCase(nmos2Name.value.trim()) && p1_source != in1 && p1_source !== in2 && p1_source !== out) {
    ...
    const p2_source = convertToLowerCase(pmos2Source.value.trim())
    const p2_body = convertToLowerCase(pmos2Body.value.trim())
    if (p2_drain === p1_source && (p2_gate === in1 || p2_gate === in2) && p1_gate !== p2_gate && p2_source === "vdd" && p2_body === "vdd") {
        p2 = true;
    }
    ...
    const n1_source = convertToLowerCase(nmos1Source.value.trim())
    const n1_body = convertToLowerCase(nmos1Body.value.trim())
    if (n1_drain === out && (n1_gate === in1 || n1_gate === in2) && n1_gate === p2_gate && (n1_body === "0" || n1_body === "gnd") && (n1_source === "0" || n1_source === "gnd")) {
        n1 = true;
    }
    ...
    const n2_source = convertToLowerCase(nmos2Source.value.trim())
    const n2_body = convertToLowerCase(nmos2Body.value.trim())
    if (n2_drain === out && (n2_gate === in1 || n2_gate === in2) && n2_gate === p1_gate && (n2_source === "0" || n2_source === "gnd") && (n2_body === "gnd" || n2_body === "0")) {
        n2 = true;
    }
